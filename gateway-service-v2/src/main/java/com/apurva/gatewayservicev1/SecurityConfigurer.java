...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.
		csrf().disable().
		authorizeRequests().antMatchers("/signup", "/authenticate","/forgot-password/**", "/confirm-account**", "/api/**", "/", "/rating-review/review/**", "/inventoryservice/**").permitAll().and().authorizeRequests().		
